...
import (
	...
	"github.com/imneov/PostgreCRD/internal/parse/json/jsonparser"
	"github.com/imneov/PostgreCRD/internal/parse/ruleql/parser"
	"strings"
)
...
func ParseTopic(expr string) (Expr, error) {
	parse, listener := parse(expr)
	antlr.ParseTreeWalkerDefault.Walk(listener, parse.Topic())
